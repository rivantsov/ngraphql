...
namespace NGraphQL.Model.Request {
  ...
  public class SelectionField : SelectionItem {
    public string Alias;
  ...
  public class GraphQLOperation : SelectionField {
    ...
    public IList<VariableDecl> Variables = new List<VariableDecl>();
  ...
  public class VariableDecl : NamedRequestObject {
    ...
    public static readonly VariableDecl[] EmptyList = new VariableDecl[] { };
  }
